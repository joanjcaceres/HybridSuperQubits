...
class FluxoniumManager():
    ...
    def fluxonium_creator(self, params, **kwargs):
        ...
        return sq.Fluxonium(EC=Ec, EL=El, EJ=Ej, flux=flux, cutoff=120, **kwargs) #Change later to consider both fluxes.
    ...
    def optimal_fluxonium(self, bounds):
        #TODO: Add the bounds as a dictionary to be more understandable.
        bounds_list = list(bounds.values())
        self.result = differential_evolution(func=self._optimizer,bounds=bounds_list) #optimizing the T2 of the fluxonium.
        return self.fluxonium_creator(self.result.x)
